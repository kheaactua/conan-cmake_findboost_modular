...
function(ensure_upper_snake_case snake src)
    string(REGEX MATCHALL "_[^A-Z]" MATCHES ${src})
    foreach(m IN ITEMS ${MATCHES})
        string(SUBSTRING ${m} 1 2 first)
        string(TOUPPER ${first} first)
        string(REPLACE "${m}" "_${first}" src "${src}")
    endforeach()
    set(${snake} ${src} PARENT_SCOPE)
endfunction()
...
function(first_character_to_upper dst src)
    ...
    ensure_upper_snake_case(snake ${FIRST}${remaining})

    set(${dst} ${snake} PARENT_SCOPE)
endfunction()

foreach(component ${Boost_FIND_COMPONENTS})
    if(NOT TARGET Boost::${component})
        first_character_to_upper(Component ${component})
        add_cloned_imported_target(Boost::${component} CONAN_PKG::Boost.${Component})
    endif()
endforeach()
